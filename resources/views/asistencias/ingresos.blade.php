            ...
            <div class="card-header">
                <div class="row">                
                    ...
                    <div class="col-md-4 col-sm-12">
                        <button class="btn btn-primary mr-1" id="startScanner">Ingreso QR</button>
...
<script>    
    $('#startScanner').click(function() {
        $.ajax({
            ...
            data: {
                ...
                newValue: '1' // El valor que deseas enviar
            },
    ...
    scanner.addListener('scan', function (content) {
        ...
        window.location.href = content; // Ejemplo si el QR contiene una URL
    });
